...
📱 **Companion Mobile App**: [JANMARG-APP](https://github.com/itsaryanchauhan/JANMARG-APP)
...
1. **Clone and install**
   ...
   ```bash
   git clone https://github.com/Priyanshuu070/Janmarg-website
   cd Janmarg-website
   npm install
   ```
...
Have questions or suggestions? Open an issue on the [GitHub repository](https://github.com/Priyanshuu070/Janmarg-website).
